...
async function createManualMemberRecord({ pool, body, files, adminId, adminBranch, adminRole, req }) {
  ...
  const branch = String(adminRole || "").toUpperCase() === "SUPER_ADMIN"
    ? requestedBranch
    : (adminBranch || "Consejo Nacional - Lima");
